  ...
  return (
    <div className="flex flex-col gap-8 ">
      <div className="flex justify-between max-sm:flex-col max-sm:gap-6">
        ...
        <div className="flex items-center py-2.5 px-2.5 bg-[#F2F4F7] rounded-lg gap-2.5">
      ...
      <div className="w-full max-lg:overflow-x-scroll">
        <table className="w-full border border-solid border-[#98A2B3] border-t-0 border-x-0 ">
          <thead>
            <tr>
